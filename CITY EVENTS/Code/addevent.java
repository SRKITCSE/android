    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST,"http://srkevents.16mb.com/naveen/events_cultural.php",
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                Toast.makeText(addevent.this,"event has been added successfuly",Toast.LENGTH_LONG).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(addevent.this, error.toString()+"...........error", Toast.LENGTH_LONG).show();
                            }
                        })
