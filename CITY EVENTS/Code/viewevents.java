...
public class viewevents extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            lv.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    Intent i = new Intent(viewevents.this, MainActivity.class);
                    startActivity(i);
                }
            });
        ...
        private class GetContacts extends AsyncTask<Void, Void, Void> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                Toast.makeText(viewevents.this,"Json Data is downloading",Toast.LENGTH_LONG).show();
            ...
            protected Void doInBackground(Void... arg0) {
                ...
                String url = "http://srkevents.16mb.com/naveen/get_events_cultural.php";
            ...
            protected void onPostExecute(Void result) {
                ...
                ListAdapter adapter = new SimpleAdapter(viewevents.this, contactList,
