...
public class view_wp extends AppCompatActivity {



    private String TAG = view_wp.class.getSimpleName();
    private ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_wp);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(view_wp.this, MainActivity.class);
                startActivity(i);
            }
        });
        new view_wp.GetContacts().execute();
    }
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(view_wp.this,"Json Data is downloading",Toast.LENGTH_LONG).show();
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "http://srkevents.16mb.com/naveen/get_events_wp.php";
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(view_wp.this, contactList,
