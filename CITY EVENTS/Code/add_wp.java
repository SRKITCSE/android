...
public class add_wp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST,"http://srkevents.16mb.com/naveen/events_wp.php",
                        new Response.Listener<String>() {
                            @Override
                            public void onResponse(String response) {
                                //Toast.makeText(register.this, response+"output", Toast.LENGTH_LONG).show();
                                Intent intent=new Intent(getApplicationContext(),add_wp.class);
                                startActivity(intent);
                                Toast.makeText(add_wp.this,"event has been added successfuly",Toast.LENGTH_LONG).show();
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(add_wp.this, error.toString()+"...........error", Toast.LENGTH_LONG).show();
                            }
                        })
