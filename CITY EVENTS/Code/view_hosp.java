...
public class view_hosp extends AppCompatActivity {
    ...
    private String TAG = view_hosp.class.getSimpleName();
    private ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_hosp);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(view_hosp.this, MainActivity.class);
                startActivity(i);
            }
        });
        new view_hosp.GetContacts().execute();
    }
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(view_hosp.this,"Json Data is downloading",Toast.LENGTH_LONG).show();
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "http://srkevents.16mb.com/naveen/get_events_hosp.php";
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(view_hosp.this, contactList,
