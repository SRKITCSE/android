...
import android.util.Log;
	...
	public class S_Routes {
	   private String mServiceUrl="";
		...
		private void setDetailsToServer(String states){
			inputParam.add(new BasicNameValuePair("pno",states));
		}
			...
			if(jArray!=null){
				for (int i = 0; i < jArray.length(); i++) {
					...
					try {
						...
						map.put("route_name",jObj.getString("route_name"));
