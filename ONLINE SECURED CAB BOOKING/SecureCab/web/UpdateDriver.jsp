...
<table align="center"  style="border: #ff6666  thin;padding: 10px;border: #ff6666 double thin" cellpadding="10px;" >
    <tr><td>Driver-ID</td><td>Name</td><td>city</td><td>Email</td><td>Phone</td><td>Cab_NO</td></tr>
...
<%
                                ...
                                while(rs.next())
                                {
                                    ...
                                    String driverUserid=rs.getString("userid");
 %>                               
        <tr>
            <td><a href="UpdateDriver1.jsp?driveruserid=<%=driverUserid%>"><%=rs.getString("userid")%></a></td>
            <td><%=rs.getString("name")%></td> 
            <td><%=rs.getString("address")%></td>
             <td><%=rs.getString("email")%></td>
             <td><%=rs.getString("phone")%></td>
             <td><%=rs.getString("cabno")%></td>
        </tr>
<%
    }
/*else{
