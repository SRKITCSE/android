...
public class A_SearchItems extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actvItems.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View arg1, int arg2,long arg3) {
				...
				intent.putExtra("mUrl", "http://newtrendzzz.net16.net/NTZZZ/getAllProducatByUsername.php");//
	...
	private class ShareItem extends AsyncTask<Void, Void, Void>{
		...
		protected void onPreExecute() {
			pb=new ProgressDialog(A_SearchItems.this);
	...
	private class GetSearchItems extends AsyncTask<Void, Void, Void>{
		...
		protected void onPostExecute(Void unused){
			...
			ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(A_SearchItems.this,android.R.layout.simple_spinner_item, menus);
			dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
			ArrayAdapter adapter = new ArrayAdapter (A_SearchItems.this,android.R.layout.simple_list_item_1,srcDes);
