...
public class S_ProductName {
	...
	public S_ProductName(String url){
		mServiceUrl=url;
	}
	//...... retrieving Data from server ......
	public  ArrayList<HashMap<String, String>> getProductDetails(String itemID){
		setDetailsToServer(itemID);
		try {
	...
	private void setDetailsToServer(String itemID){
		inputParam.add(new BasicNameValuePair("uname",itemID));
	}
		...
		if(jArray!=null){
			for (int i = 0; i < jArray.length(); i++) {
				...
				try {
					...
					map.put("PhoneNumber",jObj.getString("PhoneNumber"));
					map.put("ItemName",jObj.getString("ItemName"));
					map.put("ShopName",jObj.getString("ShopName"));
					map.put("Image",jObj.getString("Image"));
					map.put("Place",jObj.getString("Place"));
					map.put("Address",jObj.getString("Address"));
					map.put("FeedBack",jObj.getString("FeedBack"));
					map.put("ShopPhoneNumber",jObj.getString("ShopPhoneNumber"));
