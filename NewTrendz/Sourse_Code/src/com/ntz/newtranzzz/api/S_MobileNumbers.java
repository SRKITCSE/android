...
public class S_MobileNumbers {
	...
	public S_MobileNumbers(String url){
		mServiceUrl=url;
	}
	//...... retrieving Data from server ......
	public  ArrayList<HashMap<String, String>> getMobileNumbers(String uname){
		...
		if(jArray!=null){
			for (int i = 0; i < jArray.length(); i++) {
				...
				try {
					...
					map.put("device_id",jObj.getString("device_id"));
